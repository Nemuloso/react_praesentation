...
// https://github.com/mrdoob/js/issues/5552
// http://en.wikipedia.org/wiki/RGBE_image_format

module.exports = function (THREE) {

	THREE.HDRLoader = THREE.RGBELoader = (function () {
		...
		RGBELoader.prototype.constructor = RGBELoader;
			...
			if (RGBE_RETURN_FAILURE !== rgbe_header_info) {
				...
				if (RGBE_RETURN_FAILURE !== image_rgba_data) {
					...
					return {
						...
						format: THREE.RGBEFormat, // handled as RGBAFormat in shaders
